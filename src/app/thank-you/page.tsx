    ...
    <>
      ...
      <section className="bg-brand-gray-50 pt-24 pb-12 sm:pt-32 sm:pb-16">
        <div className="max-w-lg mx-auto px-4 sm:px-6 text-center">
          ...
          >
            <svg
              className="h-12 w-12 text-brand-gold-dark"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth={2.5}
              stroke="currentColor"
        ...
        <div className="max-w-md mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-3">
            <a
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full bg-brand-gold/10 text-brand-gold-dark transition-all hover:bg-brand-gold hover:text-brand-black hover:-translate-y-1"
            >
        ...
        <section className="bg-brand-gray-50 py-12 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link
                href="/blog/"
                className="hidden sm:block text-sm font-semibold text-brand-gold-dark hover:text-brand-black transition-colors"
              >
                View all →
              </Link>
            </div>
              ...
              >
                {recentPosts.map((post) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      {post.serviceType && (
                        <p className="mb-1 text-[10px] font-bold tracking-wider text-brand-gold-dark uppercase">
                          {post.serviceType}
                        </p>
                      )}
                      <h3 className="text-[14px] font-bold leading-snug text-brand-black mb-2 line-clamp-2 group-hover:text-brand-gold-dark transition-colors">
                        {post.title}
                      </h3>
                      <p className="text-[12px] leading-relaxed text-brand-gray-600 line-clamp-2 mb-3">
                        {post.metaDescription}
                      </p>
                      <span className="text-[12px] font-semibold text-brand-gold-dark">
                        Read article →
                      </span>
                    </div>
                  </Link>

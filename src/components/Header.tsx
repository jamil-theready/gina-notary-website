...
export default function Header() {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-brand-black">
        <div className="mx-auto flex max-w-7xl items-center justify-center gap-6 px-6 py-1.5 sm:gap-10">
          ...
          >
            ...
            <span className="hidden sm:inline">gina.gonzalez.realtor@gmail.com</span>
            <span className="sm:hidden">Email Us</span>
          </a>
          <a
            href="tel:+14159489967"
            className="flex items-center gap-1.5 text-[12px] font-medium text-white transition-colors hover:text-brand-gold"
          >
            <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <header
        className="fixed top-[32px] left-0 right-0 z-50 bg-brand-white"
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <Link
              href="/contact/"
              className="rounded-full bg-brand-gold hover:bg-brand-gold-dark px-6 py-2.5 text-[15px] font-semibold text-brand-black transition-colors"
            >
              Get Notarized
            </Link>
          </nav>

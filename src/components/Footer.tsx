      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="flex items-center justify-between mb-10 pb-8 border-b border-brand-gray-200">
          ...
          <nav className="flex items-center gap-8">
            ...
            <Link href="/contact/" className="text-brand-black font-semibold text-[15px] hover:text-brand-gold-dark transition-colors">Contact</Link>
          </nav>
        </div>
        ...
        <div className="relative mt-12 pt-8 border-t border-brand-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a href="https://www.instagram.com/ginagonzaleznotary/" target="_blank" rel="noopener noreferrer" className="text-brand-gray-400 hover:text-brand-gold-dark transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/ginagonzaleznotary/" target="_blank" rel="noopener noreferrer" className="text-brand-gray-400 hover:text-brand-gold-dark transition-colors" aria-label="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
            </a>
            <a href="https://www.tiktok.com/@ginagonzaleznotary" target="_blank" rel="noopener noreferrer" className="text-brand-gray-400 hover:text-brand-gold-dark transition-colors" aria-label="TikTok">

...
GMAIL_LABEL = "Synced-GinaLeads"

SHEET_ID = "1acO0nmC4xnGXM4k1niXWWLWVESv9Vz3vAmSGNbSxvD4"
SHEET_TAB = "Sheet1"

# Subjects we recognize as Gina leads
SUBJECT_PATTERNS = [
    re.compile(r"^Gina Notary", re.IGNORECASE),
    re.compile(r"ginagonzaleznotary", re.IGNORECASE),
]

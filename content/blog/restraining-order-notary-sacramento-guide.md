...
imageAlt: "Sacramento notary assisting with restraining order court documents"
serviceType: "Court & Legal"
author: "Gina Gonzalez"
tags: ["restraining order", "Sacramento", "court documents", "notary", "legal"]
language: "en"
featured: false
draft: false
...
keyTakeaways:
  ...
  - "Temporary restraining orders (TROs) can be granted the same day you file"
  - "A court hearing for a permanent order is scheduled within 21 to 25 days"
  - "Declarations and supporting documents often require notarization"
howToTitle: "How to File a Restraining Order in Sacramento"
howToDescription: "Step-by-step process to file for a restraining order in Sacramento County."
howToSteps:
  - name: "Determine the type of restraining order"
    text: "Identify which type applies to your situation: domestic violence (DV-100), civil harassment (CH-100), elder abuse (EA-100), or workplace violence (WV-100)."
  - name: "Complete the court forms"
    text: "Fill out the appropriate request form and any supporting declarations. Include specific dates, times, and descriptions of incidents."
  - name: "File with the court clerk"
    text: "Submit your forms at the Sacramento County Superior Court, 720 9th Street. The clerk will forward them to a judge for review."
  - name: "Serve the other party"
    text: "If the TRO is granted, the other party must be personally served with the papers by someone over 18 who is not involved in the case."
  - name: "Attend the court hearing"
    text: "Appear at the scheduled hearing with your evidence. The judge will decide whether to issue a permanent restraining order."
faq:
  - question: "How much does it cost to file a restraining order in Sacramento?"
    answer: "Domestic violence restraining orders have no filing fee in California. Civil harassment orders have a filing fee that can be waived if you qualify based on income."
  - question: "Do I need a lawyer to get a restraining order?"
    answer: "No, you do not need a lawyer. The Sacramento County Superior Court has a self-help center that assists with forms. A notary can help with declarations and documents that need to be signed."
  - question: "How long does a restraining order last in California?"
    answer: "Temporary restraining orders last until the court hearing date (typically 21 to 25 days). Permanent restraining orders can last up to 5 years and can be renewed."
---
...
**Property and financial documents.** When a restraining order involves property exclusion or financial protections, related documents may need notarization. This is especially common in [divorce related proceedings](/blog/do-you-need-a-notary-for-divorce-papers-in-california/) where restraining orders overlap with family law cases.
...
I regularly notarize declarations, affidavits, witness statements, and other [court and legal proceeding documents](/notary-services/court-legal-proceedings/) for clients dealing with restraining orders and other legal matters. I also serve Spanish-speaking clients who need bilingual assistance navigating these forms.

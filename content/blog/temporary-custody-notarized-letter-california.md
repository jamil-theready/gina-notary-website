...
imageAlt: "Sacramento notary helping parent with temporary custody letter at signing appointment"
serviceType: "Legal & Personal"
author: "Gina Gonzalez"
tags: ["temporary custody", "California", "notary", "legal documents", "family law", "Sacramento", "custody letter"]
language: "en"
featured: false
draft: false
...
keyTakeaways:
  ...
  - "California does not have a specific statute for temporary custody letters, but notarization adds legal weight"
  - "The letter should include both parents' signatures whenever possible"
  - "Mobile notary services let you get the letter signed at home or your office"
howToTitle: "How to Create a Temporary Custody Notarized Letter in California"
howToDescription: "Step-by-step process for drafting and notarizing a temporary custody letter in California."
howToSteps:
  - name: "Draft the letter"
    text: "Write the letter with your child's full name, date of birth, the caregiver's full name and relationship, the specific dates of custody, and a clear description of the authority granted."
  - name: "Include required details"
    text: "Add your full legal name, address, phone number, and a statement that you are voluntarily granting temporary custody. List any medical conditions, allergies, or medications for the child."
  - name: "Get both parents to sign"
    text: "Both parents or legal guardians should sign the letter whenever possible. If the other parent is unavailable, include a written explanation."
  - name: "Notarize the document"
    text: "Sign the letter in front of a California notary public. The notary will verify your identity with a government-issued photo ID and notarize the signatures."
  - name: "Distribute copies"
    text: "Give copies to the temporary caregiver, the child's school, the pediatrician, and anyone else who may need to verify the arrangement."
faq:
  - question: "Is a temporary custody letter legally binding in California?"
    answer: "A temporary custody letter is not a court order, but a notarized version carries significant legal weight. Schools, hospitals, and authorities are far more likely to accept it when it has been notarized."
  - question: "How long can a temporary custody letter last?"
    answer: "There is no set maximum in California, but most temporary custody letters cover a period of a few days to several months. For arrangements lasting longer than six months, you may want to consider a formal guardianship through the courts."
  - question: "Do both parents need to sign a temporary custody letter?"
    answer: "Both parents should sign whenever possible. If the other parent is absent, incarcerated, or has had parental rights terminated, the available parent can sign alone with an explanation included in the letter."
  - question: "How much does it cost to notarize a temporary custody letter?"
    answer: "California notary fees are $15 per signature per notarized document. Mobile notary services may include an additional travel fee."
---
...
This type of document falls under [legal and personal notary services](/notary-services/legal-personal/) and is one of the most common family documents that parents bring to a notary.
...
If the temporary custody arrangement is ever challenged, a notarized letter holds up far better than one without a notary seal. If you are going through a [divorce or separation](/blog/do-you-need-a-notary-for-divorce-papers-in-california/), having the custody letter notarized is even more important to prevent disputes about who authorized the arrangement.
